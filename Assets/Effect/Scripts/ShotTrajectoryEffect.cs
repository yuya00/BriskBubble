...
public class ShotTrajectoryEffect : MonoBehaviour
{
    ...
    public Vector3 rot = new Vector3(80, 0, 80);
    void Start()
    {
        // モデルの色
        ...
        transform.Rotate(new Vector3(rand_rot, Random.Range(rot_, rot_2), rand_rot));
